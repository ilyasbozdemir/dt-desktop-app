  ...
  return (
    <div className="flex flex-col flex-1 min-h-0 gap-4 animate-in fade-in slide-in-from-bottom-4 duration-300">
      <div className="flex items-center justify-between flex-none">
        <div className="w-full bg-indigo-50/40 dark:bg-indigo-950/10 border border-indigo-100/50 dark:border-indigo-900/30 p-4 rounded-2xl flex items-start gap-3.5 shadow-sm">
          <div className="bg-indigo-100/70 dark:bg-indigo-900/40 p-2 rounded-xl shrink-0 text-indigo-600 dark:text-indigo-400">
